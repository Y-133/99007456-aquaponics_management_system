...
| 6 | PT100:<br> <p align="justify"> Resistance temperature detector (Resistance thermometer), are sensors used to measure temperature. RTD elements consist of a length of fine wire wrapped around a ceramic or glass core but other constructions are also used. The RTD wire is a pure material, typically platinum, nickel, or copper. To measures temperature the resistance of a metal change with temperature is used. In practice, an electrical current is transmitted through a piece of metal (the RTD element or resistor) located in proximity to the area where temperature is to be measured.  A thin-film RTD element shall be used here to monitor the temperature of the system. But for simulation we have considered its equivalent PT100 </p>| ![RTD](https://github.com/Y-133/M2-EmbSys/blob/main/PROJECT/IMAGES/RTD.jpg) |
| 7 | Resistor: <br><p align ="justify"> A resistor is a passive electrical component thatis used to reduce current flow, adjust signal levels, to divide voltages, bias active elements, and terminate transmission lines, among other uses. Resistor of value 10k,47k 1/4 W resistor is used Resistors are used as voltage divider, current limiters in the circuit.</p>| ![Resistor](https://github.com/Y-133/M2-EmbSys/blob/693f8c454e0c6e4231c55214d84d127a77ff6d66/PROJECT/IMAGES/resistor.jpg) |
| 8 | Electrolytic capacitor:<br><p align ="justify"> An electrolytic capacitor is a polarized capacitor whose anode or positive plate is made of a metal that forms an insulating oxide layer through anodization. This oxide layer acts as the dielectric of the capacitor. Electrolytic Capacitors are generally used in DC power supply circuits due to their large capacitance's and small size to help reduce the ripple voltage or for coupling and decoupling applications. The capacitor of value 10µF 47µc in series with the loudspeaker is used to block DC current which could potentially destroy both the amplifier and the speake. The capacitor of value 100µc and 10nF is used as the filter   </p> | ![Electrolytic capacitor](https://github.com/Y-133/M2-EmbSys/blob/78faec678318042dd9272d284aa31496e25b98a0/PROJECT/IMAGES/Electrolytic%20Capacitor.jpg) |
| 9 | Battery:<br><p align ="justify"> An electric battery is a source of electric power consisting of one or more electrochemical cells with external connections for powering electrical devices. Alkaline Battery of 1.5 1500mAh 5 in number is connected in series to give a 7V supply which is enough to poewr the Arduino and the other components.</p>|![AA_battery](https://github.com/Y-133/M2-EmbSys/blob/b0f14b4a0b2e846e9ccc618e0e25a61178f42803/PROJECT/IMAGES/AA_battery2.jpg) |
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
## SWOT Analysis ##
####
**STRENGTHS**   
